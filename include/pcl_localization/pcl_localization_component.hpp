...
#include "pcl_localization_ros2/msg/localization_score.hpp"
...
class PCLLocalization : public rclcpp::Node
{
public:
  ...
  rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr
    initial_map_pub_;
  rclcpp::Publisher<pcl_localization_ros2::msg::LocalizationScore>::SharedPtr
    score_pub_;
